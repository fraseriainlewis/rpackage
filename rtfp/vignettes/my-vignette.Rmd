...
# Fit model
nsamps <- 20000       # number of posterior samples (after removing burn-in) per chain
...
adaptive_sampler = tfp.mcmc.DualAveragingStepSizeAdaptation(
    ...
    target_accept_prob=tf.cast(0.9, tf.float32))
...
py_to_r(samplesflat) # explicitly send to R
...
results['step_size']
results['step_size'][0][999] #step size for mu0 at iteration 999+1
```
